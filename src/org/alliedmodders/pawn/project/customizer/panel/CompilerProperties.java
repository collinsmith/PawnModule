...
public class CompilerProperties implements ProjectCustomizer.CompositeCategoryProvider {
	...
	compilerPath.setToolTipText("../addons/amxmodx/scripting/amxxpc.exe");
	...
	b.addActionListener(new ActionListener() {
		...
		jfc.setFileFilter(new FileFilter() {
			...
			return f.getName().equalsIgnoreCase("amxxpc.exe");
		    }
	...
	pluginsDir.setToolTipText("../addons/amxmodx/plugins/");
